...
class ScaleServiceArgs:
    def __init__(__self__, *,
                 num_instances: pulumi.Input[builtins.int],
    ...
    def num_instances(self) -> pulumi.Input[builtins.int]:
        return pulumi.get(self, "num_instances")

    @num_instances.setter
    def num_instances(self, value: pulumi.Input[builtins.int]):
...
class ScaleService(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="numInstances")
    def num_instances(self) -> pulumi.Output[builtins.int]:
        return pulumi.get(self, "num_instances")
