...
class KeyValueArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] owner_id: The ID of the owner of the Key Value instance
        :param pulumi.Input['MaxmemoryPolicy'] maxmemory_policy: The eviction policy for the Key Value instance
        :param pulumi.Input[str] name: The name of the Key Value instance
        :param pulumi.Input[str] region: The region where the Key Value instance is located
        """
