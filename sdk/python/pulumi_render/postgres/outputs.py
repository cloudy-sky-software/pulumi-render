...
@pulumi.output_type
class GetPostgresRecoveryInfoProperties(dict):
    def __init__(__self__, *,
                 recovery_status: 'GetPostgresRecoveryInfoPropertiesRecoveryStatus',
                 starts_at: Optional[str] = None):
        """
        :param 'GetPostgresRecoveryInfoPropertiesRecoveryStatus' recovery_status: Availability of point-in-time recovery.
        """
...
@pulumi.output_type
class PostgresConnectionInfo(dict):
    def __init__(__self__, *,
...
class PostgresDetail(dict):
    def __init__(__self__, *,
                 ...
                 name: str,
                 owner: 'outputs.Owner',
                 plan: 'PostgresDetailPlan',
                 read_replicas: Sequence['outputs.ReadReplica'],
                 region: Optional['PostgresDetailRegion'] = None,
                 role: 'PostgresDetailRole',
                 status: 'PostgresDetailStatus',
                 suspended: 'PostgresDetailSuspended',
                 suspenders: Sequence['PostgresDetailSuspendersItem'],
                 updated_at: str,
                 version: 'PostgresDetailVersion',
                 disk_size_gb: Optional[int] = None,
                 environment_id: Optional[str] = None,
                 expires_at: Optional[str] = None,
                 maintenance: Optional['outputs.RedisDetailpropertiesmaintenance'] = None,
                 primary_postgres_id: Optional[str] = None):
        """
        :param str dashboard_url: The URL to view the PostgreSQL instance in the Render Dashboard
        :param 'PostgresDetailRegion' region: Defaults to "oregon"
        :param 'PostgresDetailVersion' version: The PostgreSQL version
        :param str expires_at: The time at which the database will be expire. Applies to free tier databases only.
        """
        pulumi.set(__self__, "created_at", created_at)
        pulumi.set(__self__, "dashboard_url", dashboard_url)
