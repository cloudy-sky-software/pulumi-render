...
class Redis(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str name: The name of the Redis instance
        :param 'RedisOptions' options: Options for a Redis instance
        :param 'RedisRegion' region: Defaults to "oregon"
        :param _builtins.str updated_at: The last updated time of the Redis instance
        :param _builtins.str version: The version of Redis
        :param _builtins.str environment_id: The ID of the environment the Redis instance is associated with
        """
