...
def get_web_service(service_id: Optional[builtins.str] = None,
...
def get_web_service_output(service_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('render:services:getWebService', __args__, opts=opts, typ=GetWebServiceResult)
