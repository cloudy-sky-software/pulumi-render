...
class CronJob(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            CronJobArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if service_details is not None and not isinstance(service_details, CronJobServiceDetailsArgs):
                service_details = service_details or {}
                def _setter(key, value):
                    service_details[key] = value
                CronJobServiceDetailsArgs._configure(_setter, **service_details)
