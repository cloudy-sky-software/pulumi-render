...
class RedisArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] owner_id: The ID of the owner of the Redis instance
        :param pulumi.Input['MaxmemoryPolicy'] maxmemory_policy: The eviction policy for the Key Value instance
        :param pulumi.Input[builtins.str] name: The name of the Redis instance
        :param pulumi.Input[builtins.str] region: The region where the Redis instance is located
        """
