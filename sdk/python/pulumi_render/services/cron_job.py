...
class CronJob(pulumi.CustomResource):
    ...
    def auto_deploy(self) -> pulumi.Output['CronJobAutoDeploy']:
    ...
    def notify_on_fail(self) -> pulumi.Output['CronJobNotifyOnFail']:
    ...
    @property
    @pulumi.getter(name="serviceDetails")
    def service_details(self) -> pulumi.Output['outputs.CronJobDetailsCreate']:
        return pulumi.get(self, "service_details")
    ...
    @property
    @pulumi.getter
    def suspended(self) -> pulumi.Output['CronJobSuspended']:
        return pulumi.get(self, "suspended")

    @property
    @pulumi.getter
    def suspenders(self) -> pulumi.Output[Sequence['CronJobSuspendersItem']]:
