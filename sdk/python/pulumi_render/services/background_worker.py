...
class BackgroundWorkerArgs:
    def __init__(__self__, *,
                 ...
                 service_details: pulumi.Input[Optional['BackgroundWorkerDetailsCreateArgs']] = None,
    ...
    def service_details(self) -> pulumi.Input[Optional['BackgroundWorkerDetailsCreateArgs']]:
        return pulumi.get(self, "service_details")

    @service_details.setter
    def service_details(self, value: pulumi.Input[Optional['BackgroundWorkerDetailsCreateArgs']]):
...
class BackgroundWorker(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 auto_deploy: pulumi.Input[Optional['ServiceCreateAutoDeploy']] = None,
                 branch: pulumi.Input[Optional[_builtins.str]] = None,
                 build_filter: pulumi.Input[Optional[Union['BuildFilterArgs', 'BuildFilterArgsDict', 'outputs.BuildFilter']]] = None,
                 ...
                 service_details: pulumi.Input[Optional[Union['BackgroundWorkerDetailsCreateArgs', 'BackgroundWorkerDetailsCreateArgsDict']]] = None,
                 type: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
    ...
    def dashboard_url(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="rootDir")
    def root_dir(self) -> pulumi.Output[Optional[_builtins.str]]:
        return pulumi.get(self, "root_dir")
