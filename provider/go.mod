...
require (
	github.com/cloudy-sky-software/pulschema v0.0.0-20221101085541-6f01585bfcb8
	github.com/cloudy-sky-software/pulumi-provider-framework v0.0.0-20221101085615-cdca29a6fa4a
