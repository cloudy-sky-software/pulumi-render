...
export class WebService extends pulumi.CustomResource {
    ...
    declare public readonly serviceDetails: pulumi.Output<outputs.services.WebServiceDetailsOutput | undefined>;
    ...
    constructor(name: string, args: WebServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["serviceDetails"] = args ? pulumi.output(args.serviceDetails).apply(v => v === undefined ? undefined : inputs.services.webServiceDetailsCreateArgsProvideDefaults(v)) : undefined;
            resourceInputs["type"] = (args?.type) ?? "web_service";
...
export interface WebServiceArgs {
    ...
    serviceDetails?: pulumi.Input<inputs.services.WebServiceDetailsCreateArgs | undefined>;
