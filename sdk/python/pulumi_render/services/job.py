...
class JobArgs:
    ...
    def start_command(self) -> pulumi.Input[_builtins.str]:
        return pulumi.get(self, "start_command")

    @start_command.setter
    def start_command(self, value: pulumi.Input[_builtins.str]):
...
class Job(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="startCommand")
    def start_command(self) -> pulumi.Output[_builtins.str]:
        return pulumi.get(self, "start_command")
