...
export class RollbackDeploy extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): RollbackDeploy {
        return new RollbackDeploy(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'render:services:RollbackDeploy';

    /**
     * Returns true if the given object is an instance of RollbackDeploy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RollbackDeploy {
    ...
    public /*out*/ readonly status!: pulumi.Output<enums.services.RollbackDeployStatus | undefined>;
    public /*out*/ readonly trigger!: pulumi.Output<enums.services.RollbackDeployTrigger | undefined>;
     ...
     */
    constructor(name: string, args: RollbackDeployArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(RollbackDeploy.__pulumiType, name, resourceInputs, opts);
    }
}
