...
class StaticSiteArgs:
    def __init__(__self__, *,
                 ...
                 service_details: pulumi.Input[Optional['StaticSiteDetailsCreateArgs']] = None,
    ...
    def service_details(self) -> pulumi.Input[Optional['StaticSiteDetailsCreateArgs']]:
        return pulumi.get(self, "service_details")

    @service_details.setter
    def service_details(self, value: pulumi.Input[Optional['StaticSiteDetailsCreateArgs']]):
...
class StaticSite(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 service_details: pulumi.Input[Optional[Union['StaticSiteDetailsCreateArgs', 'StaticSiteDetailsCreateArgsDict']]] = None,
                 type: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ## Example Usage
