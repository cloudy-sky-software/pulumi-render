...
if not MYPY:
    class BackgroundWorkerDetailsCreateArgsDict(TypedDict):
        ...
        max_shutdown_delay_seconds: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        num_instances: NotRequired[pulumi.Input[builtins.int]]
        """
        Defaults to 1
        """
        ...
        Defaults to "starter"
        """
        pre_deploy_command: NotRequired[pulumi.Input[builtins.str]]
...
class BackgroundWorkerDetailsCreateArgs:
    def __init__(__self__, *,
                 ...
                 max_shutdown_delay_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 num_instances: Optional[pulumi.Input[builtins.int]] = None,
                 plan: Optional[pulumi.Input['BackgroundWorkerDetailsCreatePlan']] = None,
                 pre_deploy_command: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] max_shutdown_delay_seconds: The maximum amount of time (in seconds) that Render waits for your application process to exit gracefully after sending it a SIGTERM signal.
        :param pulumi.Input[builtins.int] num_instances: Defaults to 1
    ...
    def max_shutdown_delay_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The maximum amount of time (in seconds) that Render waits for your application process to exit gracefully after sending it a SIGTERM signal.
        """
    ...
    def max_shutdown_delay_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "max_shutdown_delay_seconds", value)

    @property
    @pulumi.getter(name="numInstances")
    def num_instances(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Defaults to 1
        """
    ...
    def num_instances(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def pre_deploy_command(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "pre_deploy_command")

    @pre_deploy_command.setter
    def pre_deploy_command(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class BuildFilterArgsDict(TypedDict):
        ignored_paths: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
...
class BuildFilterArgs:
    ...
    def ignored_paths(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        return pulumi.get(self, "ignored_paths")

    @ignored_paths.setter
    def ignored_paths(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class CriteriaPropertiesCpuPropertiesArgs:
    def __init__(__self__, *,
                 ...
                 percentage: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] percentage: Determines when your service will be scaled. If the average resource utilization is significantly above/below the target, we will increase/decrease the number of instances.
        """
        if enabled is None:
            enabled = False
...
if not MYPY:
    class EnvSpecificDetailsCreateArgsDict(TypedDict):
        ...
        docker_command: NotRequired[pulumi.Input[builtins.str]]
        docker_context: NotRequired[pulumi.Input[builtins.str]]
        dockerfile_path: NotRequired[pulumi.Input[builtins.str]]
        """
        Defaults to "./Dockerfile"
        """
        registry_credential_id: NotRequired[pulumi.Input[builtins.str]]
        start_command: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class EnvSpecificDetailsCreateArgs:
    def __init__(__self__, *,
                 ...
                 docker_command: Optional[pulumi.Input[builtins.str]] = None,
                 docker_context: Optional[pulumi.Input[builtins.str]] = None,
                 dockerfile_path: Optional[pulumi.Input[builtins.str]] = None,
                 registry_credential_id: Optional[pulumi.Input[builtins.str]] = None,
                 start_command: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] dockerfile_path: Defaults to "./Dockerfile"
        """
    ...
    def docker_command(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "docker_command")

    @docker_command.setter
    def docker_command(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "docker_command", value)

    @property
    @pulumi.getter(name="dockerContext")
    def docker_context(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "docker_context")

    @docker_context.setter
    def docker_context(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def registry_credential_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "registry_credential_id")

    @registry_credential_id.setter
    def registry_credential_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "registry_credential_id", value)

    @property
    @pulumi.getter(name="startCommand")
    def start_command(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "start_command")

    @start_command.setter
    def start_command(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class EnvVarInputArgsDict(TypedDict):
        generate_value: NotRequired[pulumi.Input[builtins.bool]]
...
class HeaderInputArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] path: The request path to add the header to. Wildcards will cause headers to be applied to all matching paths.
...
if not MYPY:
    class ImageArgsDict(TypedDict):
        image_path: pulumi.Input[builtins.str]
        """
...
class ImageArgs:
    def __init__(__self__, *,
                 ...
                 registry_credential_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] image_path: Path to the image used for this server (e.g docker.io/library/nginx:latest).
        :param pulumi.Input[builtins.str] owner_id: The ID of the owner for this image. This should match the owner of the service as well as the owner of any specified registry credential.
        :param pulumi.Input[builtins.str] registry_credential_id: Optional reference to the registry credential passed to the image repository to retrieve this image.
        """
    ...
    def image_path(self) -> pulumi.Input[builtins.str]:
        """
        Path to the image used for this server (e.g docker.io/library/nginx:latest).
        """
    ...
    @image_path.setter
    def image_path(self, value: pulumi.Input[builtins.str]):
...
class MaintenanceModeArgs:
    def __init__(__self__, *,
                 ...
                 uri: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] uri: The page to be served when [maintenance mode](https://docs.render.com/maintenance-mode) is enabled. When empty, the default maintenance mode page is served.
        """
        pulumi.set(__self__, "enabled", enabled)
...
if not MYPY:
    class RegistryCredentialArgsDict(TypedDict):
        ...
        """
        updated_at: pulumi.Input[builtins.str]
        """
...
class RegistryCredentialArgs:
    def __init__(__self__, *,
                 ...
                 username: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] id: Unique identifier for this credential
        :param pulumi.Input[builtins.str] name: Descriptive name for this credential
        :param pulumi.Input['RegistryCredentialRegistry'] registry: The registry to use this credential with
        :param pulumi.Input[builtins.str] updated_at: Last updated time for the credential
        :param pulumi.Input[builtins.str] username: The username associated with the credential
        """
    ...
    def updated_at(self) -> pulumi.Input[builtins.str]:
        """
        Last updated time for the credential
        """
    ...
    @updated_at.setter
    def updated_at(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class ServiceDiskArgsDict(TypedDict):
        ...
        name: pulumi.Input[builtins.str]
        size_gb: NotRequired[pulumi.Input[builtins.int]]
        """
        Defaults to 1
        """
elif False:
...
class ServiceDiskArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] size_gb: Defaults to 1
        """
...
if not MYPY:
    class StaticSiteDetailsCreateArgsDict(TypedDict):
        ...
        previews: NotRequired[pulumi.Input['PreviewsArgsDict']]
        publish_path: NotRequired[pulumi.Input[builtins.str]]
        """
        Defaults to "public"
        """
...
class StaticSiteDetailsCreateArgs:
    def __init__(__self__, *,
                 ...
                 previews: Optional[pulumi.Input['PreviewsArgs']] = None,
                 publish_path: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] publish_path: Defaults to "public"
    ...
    def publish_path(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Defaults to "public"
        """
    ...
    @publish_path.setter
    def publish_path(self, value: Optional[pulumi.Input[builtins.str]]):
...
class WebServiceDetailspropertiesautoscalingArgs:
    def __init__(__self__, *,
                 ...
                 min: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] max: The maximum number of instances for the service
        :param pulumi.Input[builtins.int] min: The minimum number of instances for the service
        """
