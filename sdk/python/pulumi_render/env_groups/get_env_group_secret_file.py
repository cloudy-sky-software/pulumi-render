...
def get_env_group_secret_file(env_group_id: Optional[builtins.str] = None,
                              secret_file_name: Optional[builtins.str] = None,
    ...
    :param builtins.str secret_file_name: The name of the secret file
    """
    __args__ = dict()
...
def get_env_group_secret_file_output(env_group_id: Optional[pulumi.Input[builtins.str]] = None,
