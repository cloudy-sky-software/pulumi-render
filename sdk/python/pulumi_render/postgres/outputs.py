...
class ListPostgresExportItemProperties(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str url: URL to download the Postgres export
        """
...
class Postgres(dict):
    def __init__(__self__, *,
                 ...
                 high_availability_enabled: builtins.bool,
                 id: builtins.str,
                 ...
                 primary_postgres_id: Optional[builtins.str] = None):
        """
        :param builtins.str dashboard_url: The URL to view the Postgres instance in the Render Dashboard
        :param 'PostgresRegion' region: Defaults to "oregon"
        :param 'PostgresVersion' version: The PostgreSQL version
        :param builtins.str expires_at: The time at which the database will be expire. Applies to free tier databases only.
        """
        pulumi.set(__self__, "created_at", created_at)
    ...
    def high_availability_enabled(self) -> builtins.bool:
    ...
    def primary_postgres_id(self) -> Optional[builtins.str]:
...
class ReadReplica(dict):
    def __init__(__self__, *,
                 ...
                 name: builtins.str):
        """
        :param builtins.str id: The replica instance identifier.
        :param builtins.str name: The display name of the replica instance.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "name", name)
