...
class AwaitableGetCronJob(GetCronJob):
...
def get_cron_job(service_id: Optional[builtins.str] = None,
                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCronJob:
    """
    ...
    __ret__ = pulumi.runtime.invoke('render:services:getCronJob', __args__, opts=opts, typ=GetCronJob).value

    return AwaitableGetCronJob(
