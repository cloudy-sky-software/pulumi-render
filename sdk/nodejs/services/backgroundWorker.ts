...
export class BackgroundWorker extends pulumi.CustomResource {
    ...
    public readonly autoDeploy!: pulumi.Output<enums.services.BackgroundWorkerServiceAutoDeploy | undefined>;
...
export interface BackgroundWorkerArgs {
     ...
     * Defaults to "yes"
     */
    autoDeploy?: pulumi.Input<enums.services.BackgroundWorkerServiceCreateAutoDeploy>;
    /**
