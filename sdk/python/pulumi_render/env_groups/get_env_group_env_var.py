...
def get_env_group_env_var(env_group_id: Optional[builtins.str] = None,
                          env_var_key: Optional[builtins.str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEnvGroupEnvVarResult:
    """
    Use this data source to access information about an existing resource.

    :param builtins.str env_group_id: Filter for resources that belong to an environment group
    :param builtins.str env_var_key: The name of the environment variable
    """
    __args__ = dict()
...
def get_env_group_env_var_output(env_group_id: Optional[pulumi.Input[builtins.str]] = None,
