...
class CancelDeployArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] deploy_id: The ID of the deploy
    ...
    def deploy_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @deploy_id.setter
    def deploy_id(self, value: Optional[pulumi.Input[builtins.str]]):
