...
class GetPostgresRecoveryInfoProperties:
    ...
    def starts_at(self) -> Optional[builtins.str]:
...
def get_postgres_recovery_info(postgres_id: Optional[builtins.str] = None,
...
def get_postgres_recovery_info_output(postgres_id: Optional[pulumi.Input[builtins.str]] = None,
