...
class GetOwnerNotificationSettingProperties:
    ...
    def email_enabled(self) -> builtins.bool:
    ...
    def preview_notifications_enabled(self) -> builtins.bool:
        return pulumi.get(self, "preview_notifications_enabled")

    @property
    @pulumi.getter(name="slackEnabled")
    def slack_enabled(self) -> builtins.bool:
...
def get_owner_notification_setting(owner_id: Optional[builtins.str] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOwnerNotificationSettingProperties:
    """
    Use this data source to access information about an existing resource.

    :param builtins.str owner_id: The ID of the owner (team or personal user) whose resources should be returned
    """
    __args__ = dict()
...
def get_owner_notification_setting_output(owner_id: Optional[pulumi.Input[builtins.str]] = None,
