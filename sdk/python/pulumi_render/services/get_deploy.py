...
def get_deploy_output(deploy_id: Optional[pulumi.Input[builtins.str]] = None,
                      service_id: Optional[pulumi.Input[builtins.str]] = None,
                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[Deploy]:
    """
    Use this data source to access information about an existing resource.
