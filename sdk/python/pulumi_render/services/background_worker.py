...
class BackgroundWorkerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] branch: If left empty, this will fall back to the default branch of the repository
        :param pulumi.Input[builtins.str] repo: Do not include the branch in the repo string. You can instead supply a 'branch' parameter.
        """
...
class BackgroundWorker(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 service_details: Optional[pulumi.Input[Union['BackgroundWorkerDetailsCreateArgs', 'BackgroundWorkerDetailsCreateArgsDict']]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None,
                 __props__=None):
        """
    ...
    def dashboard_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
    ...
    @property
    @pulumi.getter
    def repo(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "repo")

    @property
    @pulumi.getter(name="rootDir")
    def root_dir(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "root_dir")
    ...
    @property
    @pulumi.getter
    def slug(self) -> pulumi.Output[Optional[builtins.str]]:
