...
require (
	github.com/cloudy-sky-software/pulschema v0.0.0-20230721002746-792e4c3d2ea5
	github.com/cloudy-sky-software/pulumi-provider-framework v0.0.0-20230721002810-9b7cef310b5a
