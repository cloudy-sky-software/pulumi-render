...
// A Key Value instance
type KeyValueConnectionInfoOutput struct{ *pulumi.OutputState }

func (KeyValueConnectionInfoOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*KeyValueConnectionInfo)(nil)).Elem()
}

func (o KeyValueConnectionInfoOutput) ToKeyValueConnectionInfoOutput() KeyValueConnectionInfoOutput {
	return o
}

func (o KeyValueConnectionInfoOutput) ToKeyValueConnectionInfoOutputWithContext(ctx context.Context) KeyValueConnectionInfoOutput {
	return o
}

// The CLI (redis-cli or valkey-cli) command to connect to the Key Value instance
func (o KeyValueConnectionInfoOutput) CliCommand() pulumi.StringOutput {
	return o.ApplyT(func(v KeyValueConnectionInfo) string { return v.CliCommand }).(pulumi.StringOutput)
}

// The connection string to use from outside Render
func (o KeyValueConnectionInfoOutput) ExternalConnectionString() pulumi.StringOutput {
	return o.ApplyT(func(v KeyValueConnectionInfo) string { return v.ExternalConnectionString }).(pulumi.StringOutput)
}

// The connection string to use from within Render
func (o KeyValueConnectionInfoOutput) InternalConnectionString() pulumi.StringOutput {
	return o.ApplyT(func(v KeyValueConnectionInfo) string { return v.InternalConnectionString }).(pulumi.StringOutput)
}
...
// A Key Value instance
type KeyValueDetailOutput struct{ *pulumi.OutputState }

func (KeyValueDetailOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*KeyValueDetail)(nil)).Elem()
}

func (o KeyValueDetailOutput) ToKeyValueDetailOutput() KeyValueDetailOutput {
	return o
}

func (o KeyValueDetailOutput) ToKeyValueDetailOutputWithContext(ctx context.Context) KeyValueDetailOutput {
	return o
}

// The creation time of the Key Value instance
func (o KeyValueDetailOutput) CreatedAt() pulumi.StringOutput {
	return o.ApplyT(func(v KeyValueDetail) string { return v.CreatedAt }).(pulumi.StringOutput)
}

// The ID of the environment the Key Value instance is associated with
func (o KeyValueDetailOutput) EnvironmentId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v KeyValueDetail) *string { return v.EnvironmentId }).(pulumi.StringPtrOutput)
}

// The ID of the Key Value instance
func (o KeyValueDetailOutput) Id() pulumi.StringOutput {
	return o.ApplyT(func(v KeyValueDetail) string { return v.Id }).(pulumi.StringOutput)
}

// The IP allow list for the Key Value instance
func (o KeyValueDetailOutput) IpAllowList() CidrBlockAndDescriptionArrayOutput {
	return o.ApplyT(func(v KeyValueDetail) []CidrBlockAndDescription { return v.IpAllowList }).(CidrBlockAndDescriptionArrayOutput)
}

func (o KeyValueDetailOutput) Maintenance() RedisDetailpropertiesmaintenancePtrOutput {
	return o.ApplyT(func(v KeyValueDetail) *RedisDetailpropertiesmaintenance { return v.Maintenance }).(RedisDetailpropertiesmaintenancePtrOutput)
}

// The name of the Key Value instance
func (o KeyValueDetailOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v KeyValueDetail) string { return v.Name }).(pulumi.StringOutput)
}

// Options for a Key Value instance
func (o KeyValueDetailOutput) Options() KeyValueOptionsOutput {
	return o.ApplyT(func(v KeyValueDetail) KeyValueOptions { return v.Options }).(KeyValueOptionsOutput)
}

func (o KeyValueDetailOutput) Owner() OwnerOutput {
	return o.ApplyT(func(v KeyValueDetail) Owner { return v.Owner }).(OwnerOutput)
}

func (o KeyValueDetailOutput) Plan() KeyValueDetailPlanOutput {
	return o.ApplyT(func(v KeyValueDetail) KeyValueDetailPlan { return v.Plan }).(KeyValueDetailPlanOutput)
}

// Defaults to "oregon"
func (o KeyValueDetailOutput) Region() KeyValueDetailRegionOutput {
	return o.ApplyT(func(v KeyValueDetail) KeyValueDetailRegion { return v.Region }).(KeyValueDetailRegionOutput)
}

func (o KeyValueDetailOutput) Status() KeyValueDetailStatusOutput {
	return o.ApplyT(func(v KeyValueDetail) KeyValueDetailStatus { return v.Status }).(KeyValueDetailStatusOutput)
}

// The last updated time of the Key Value instance
func (o KeyValueDetailOutput) UpdatedAt() pulumi.StringOutput {
	return o.ApplyT(func(v KeyValueDetail) string { return v.UpdatedAt }).(pulumi.StringOutput)
}

// The version of Key Value
func (o KeyValueDetailOutput) Version() pulumi.StringOutput {
	return o.ApplyT(func(v KeyValueDetail) string { return v.Version }).(pulumi.StringOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(KeyValueConnectionInfoOutput{})
	pulumi.RegisterOutputType(KeyValueDetailOutput{})
