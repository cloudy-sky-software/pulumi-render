...
type GetPostgresRecoveryInfoPropertiesOutput struct{ *pulumi.OutputState }

func (GetPostgresRecoveryInfoPropertiesOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetPostgresRecoveryInfoProperties)(nil)).Elem()
}

func (o GetPostgresRecoveryInfoPropertiesOutput) ToGetPostgresRecoveryInfoPropertiesOutput() GetPostgresRecoveryInfoPropertiesOutput {
	return o
}

func (o GetPostgresRecoveryInfoPropertiesOutput) ToGetPostgresRecoveryInfoPropertiesOutputWithContext(ctx context.Context) GetPostgresRecoveryInfoPropertiesOutput {
	return o
}

// Availability of point-in-time recovery.
func (o GetPostgresRecoveryInfoPropertiesOutput) RecoveryStatus() GetPostgresRecoveryInfoPropertiesRecoveryStatusOutput {
	return o.ApplyT(func(v GetPostgresRecoveryInfoProperties) GetPostgresRecoveryInfoPropertiesRecoveryStatus {
		return v.RecoveryStatus
	}).(GetPostgresRecoveryInfoPropertiesRecoveryStatusOutput)
}

func (o GetPostgresRecoveryInfoPropertiesOutput) StartsAt() pulumi.StringPtrOutput {
...
type PostgresConnectionInfoOutput struct{ *pulumi.OutputState }

func (PostgresConnectionInfoOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*PostgresConnectionInfo)(nil)).Elem()
}

func (o PostgresConnectionInfoOutput) ToPostgresConnectionInfoOutput() PostgresConnectionInfoOutput {
	return o
}

func (o PostgresConnectionInfoOutput) ToPostgresConnectionInfoOutputWithContext(ctx context.Context) PostgresConnectionInfoOutput {
	return o
}

func (o PostgresConnectionInfoOutput) ExternalConnectionString() pulumi.StringOutput {
	return o.ApplyT(func(v PostgresConnectionInfo) string { return v.ExternalConnectionString }).(pulumi.StringOutput)
}

func (o PostgresConnectionInfoOutput) InternalConnectionString() pulumi.StringOutput {
	return o.ApplyT(func(v PostgresConnectionInfo) string { return v.InternalConnectionString }).(pulumi.StringOutput)
}

func (o PostgresConnectionInfoOutput) Password() pulumi.StringOutput {
	return o.ApplyT(func(v PostgresConnectionInfo) string { return v.Password }).(pulumi.StringOutput)
}

func (o PostgresConnectionInfoOutput) PsqlCommand() pulumi.StringOutput {
	return o.ApplyT(func(v PostgresConnectionInfo) string { return v.PsqlCommand }).(pulumi.StringOutput)
}
...
type PostgresDetailOutput struct{ *pulumi.OutputState }

func (PostgresDetailOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*PostgresDetail)(nil)).Elem()
}

func (o PostgresDetailOutput) ToPostgresDetailOutput() PostgresDetailOutput {
	return o
}

func (o PostgresDetailOutput) ToPostgresDetailOutputWithContext(ctx context.Context) PostgresDetailOutput {
	return o
}

func (o PostgresDetailOutput) CreatedAt() pulumi.StringOutput {
...
func (o PostgresDetailOutput) DatabaseName() pulumi.StringOutput {
	return o.ApplyT(func(v PostgresDetail) string { return v.DatabaseName }).(pulumi.StringOutput)
}

func (o PostgresDetailOutput) DatabaseUser() pulumi.StringOutput {
	return o.ApplyT(func(v PostgresDetail) string { return v.DatabaseUser }).(pulumi.StringOutput)
}

func (o PostgresDetailOutput) DiskSizeGB() pulumi.IntPtrOutput {
	return o.ApplyT(func(v PostgresDetail) *int { return v.DiskSizeGB }).(pulumi.IntPtrOutput)
}

func (o PostgresDetailOutput) EnvironmentId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v PostgresDetail) *string { return v.EnvironmentId }).(pulumi.StringPtrOutput)
}

// The time at which the database will be expire. Applies to free tier databases only.
func (o PostgresDetailOutput) ExpiresAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v PostgresDetail) *string { return v.ExpiresAt }).(pulumi.StringPtrOutput)
}

func (o PostgresDetailOutput) HighAvailabilityEnabled() pulumi.BoolOutput {
	return o.ApplyT(func(v PostgresDetail) bool { return v.HighAvailabilityEnabled }).(pulumi.BoolOutput)
}

func (o PostgresDetailOutput) Id() pulumi.StringOutput {
	return o.ApplyT(func(v PostgresDetail) string { return v.Id }).(pulumi.StringOutput)
}

func (o PostgresDetailOutput) IpAllowList() CidrBlockAndDescriptionArrayOutput {
	return o.ApplyT(func(v PostgresDetail) []CidrBlockAndDescription { return v.IpAllowList }).(CidrBlockAndDescriptionArrayOutput)
}

func (o PostgresDetailOutput) Maintenance() RedisDetailpropertiesmaintenancePtrOutput {
	return o.ApplyT(func(v PostgresDetail) *RedisDetailpropertiesmaintenance { return v.Maintenance }).(RedisDetailpropertiesmaintenancePtrOutput)
}

func (o PostgresDetailOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v PostgresDetail) string { return v.Name }).(pulumi.StringOutput)
}

func (o PostgresDetailOutput) Owner() OwnerOutput {
	return o.ApplyT(func(v PostgresDetail) Owner { return v.Owner }).(OwnerOutput)
}

func (o PostgresDetailOutput) Plan() PostgresDetailPlanOutput {
	return o.ApplyT(func(v PostgresDetail) PostgresDetailPlan { return v.Plan }).(PostgresDetailPlanOutput)
}

func (o PostgresDetailOutput) PrimaryPostgresID() pulumi.StringPtrOutput {
	return o.ApplyT(func(v PostgresDetail) *string { return v.PrimaryPostgresID }).(pulumi.StringPtrOutput)
}

func (o PostgresDetailOutput) ReadReplicas() ReadReplicaArrayOutput {
	return o.ApplyT(func(v PostgresDetail) []ReadReplica { return v.ReadReplicas }).(ReadReplicaArrayOutput)
}

// Defaults to "oregon"
func (o PostgresDetailOutput) Region() PostgresDetailRegionOutput {
	return o.ApplyT(func(v PostgresDetail) PostgresDetailRegion { return v.Region }).(PostgresDetailRegionOutput)
}

func (o PostgresDetailOutput) Role() PostgresDetailRoleOutput {
	return o.ApplyT(func(v PostgresDetail) PostgresDetailRole { return v.Role }).(PostgresDetailRoleOutput)
}

func (o PostgresDetailOutput) Status() PostgresDetailStatusOutput {
	return o.ApplyT(func(v PostgresDetail) PostgresDetailStatus { return v.Status }).(PostgresDetailStatusOutput)
}

func (o PostgresDetailOutput) Suspended() PostgresDetailSuspendedOutput {
	return o.ApplyT(func(v PostgresDetail) PostgresDetailSuspended { return v.Suspended }).(PostgresDetailSuspendedOutput)
}

func (o PostgresDetailOutput) Suspenders() PostgresDetailSuspendersItemArrayOutput {
	return o.ApplyT(func(v PostgresDetail) []PostgresDetailSuspendersItem { return v.Suspenders }).(PostgresDetailSuspendersItemArrayOutput)
}

func (o PostgresDetailOutput) UpdatedAt() pulumi.StringOutput {
	return o.ApplyT(func(v PostgresDetail) string { return v.UpdatedAt }).(pulumi.StringOutput)
}
