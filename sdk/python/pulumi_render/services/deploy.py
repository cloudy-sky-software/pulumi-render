...
class DeployArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] commit_id: The SHA of a specific Git commit to deploy for a service. Defaults to the latest commit on the service's connected branch.
        ...
        :param pulumi.Input[builtins.str] image_url: The URL of the image to deploy for an image-backed service.
...
@pulumi.type_token("render:services:Deploy")
class Deploy(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="commitId")
    def commit_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The SHA of a specific Git commit to deploy for a service. Defaults to the latest commit on the service's connected branch.
