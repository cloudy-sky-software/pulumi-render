...
class Postgres(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 enable_high_availability: pulumi.Input[Optional[_builtins.bool]] = None,
                 environment_id: pulumi.Input[Optional[_builtins.str]] = None,
                 ip_allow_list: pulumi.Input[Optional[Sequence[pulumi.Input[Union['CidrBlockAndDescriptionArgs', 'CidrBlockAndDescriptionArgsDict', 'outputs.CidrBlockAndDescription']]]]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
