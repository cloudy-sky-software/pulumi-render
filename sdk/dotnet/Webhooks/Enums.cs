...
namespace Pulumi.Render.Webhooks
{
    ...
    [EnumType]
    public readonly struct WebhookEventWithCursorWebhookEventPropertiesEventType : IEquatable<WebhookEventWithCursorWebhookEventPropertiesEventType>
    {
        private readonly string _value;

        private WebhookEventWithCursorWebhookEventPropertiesEventType(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }

        public static WebhookEventWithCursorWebhookEventPropertiesEventType AutoscalingConfigChanged { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("autoscaling_config_changed");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType AutoscalingEnded { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("autoscaling_ended");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType AutoscalingStarted { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("autoscaling_started");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType BranchDeleted { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("branch_deleted");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType BuildEnded { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("build_ended");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType BuildStarted { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("build_started");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType CommitIgnored { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("commit_ignored");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType CronJobRunEnded { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("cron_job_run_ended");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType CronJobRunStarted { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("cron_job_run_started");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType DeployEnded { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("deploy_ended");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType DeployStarted { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("deploy_started");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType DiskCreated { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("disk_created");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType DiskUpdated { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("disk_updated");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType DiskDeleted { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("disk_deleted");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType ImagePullFailed { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("image_pull_failed");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType InstanceCountChanged { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("instance_count_changed");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType JobRunEnded { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("job_run_ended");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType MaintenanceModeEnabled { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("maintenance_mode_enabled");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType MaintenanceModeUriUpdated { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("maintenance_mode_uri_updated");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType MaintenanceEnded { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("maintenance_ended");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType MaintenanceStarted { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("maintenance_started");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType PlanChanged { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("plan_changed");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType PreDeployEnded { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("pre_deploy_ended");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType PreDeployStarted { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("pre_deploy_started");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType ServerAvailable { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("server_available");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType ServerFailed { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("server_failed");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType ServerHardwareFailure { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("server_hardware_failure");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType ServerRestarted { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("server_restarted");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType ServerUnhealthy { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("server_unhealthy");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType ServiceResumed { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("service_resumed");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType ServiceSuspended { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("service_suspended");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType ZeroDowntimeRedeployEnded { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("zero_downtime_redeploy_ended");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType ZeroDowntimeRedeployStarted { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("zero_downtime_redeploy_started");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType PostgresAvailable { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("postgres_available");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType PostgresBackupCompleted { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("postgres_backup_completed");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType PostgresBackupStarted { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("postgres_backup_started");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType PostgresClusterLeaderChanged { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("postgres_cluster_leader_changed");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType PostgresCreated { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("postgres_created");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType PostgresDiskSizeChanged { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("postgres_disk_size_changed");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType PostgresHaStatusChanged { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("postgres_ha_status_changed");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType PostgresRestarted { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("postgres_restarted");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType PostgresUnavailable { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("postgres_unavailable");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType PostgresUpgradeFailed { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("postgres_upgrade_failed");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType PostgresUpgradeStarted { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("postgres_upgrade_started");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType PostgresUpgradeSucceeded { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("postgres_upgrade_succeeded");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType PostgresReadReplicasChanged { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("postgres_read_replicas_changed");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType KeyValueAvailable { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("key_value_available");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType KeyValueConfigRestart { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("key_value_config_restart");
        public static WebhookEventWithCursorWebhookEventPropertiesEventType KeyValueUnhealthy { get; } = new WebhookEventWithCursorWebhookEventPropertiesEventType("key_value_unhealthy");

        public static bool operator ==(WebhookEventWithCursorWebhookEventPropertiesEventType left, WebhookEventWithCursorWebhookEventPropertiesEventType right) => left.Equals(right);
        public static bool operator !=(WebhookEventWithCursorWebhookEventPropertiesEventType left, WebhookEventWithCursorWebhookEventPropertiesEventType right) => !left.Equals(right);

        public static explicit operator string(WebhookEventWithCursorWebhookEventPropertiesEventType value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is WebhookEventWithCursorWebhookEventPropertiesEventType other && Equals(other);
        public bool Equals(WebhookEventWithCursorWebhookEventPropertiesEventType other) => string.Equals(_value, other._value, StringComparison.Ordinal);
