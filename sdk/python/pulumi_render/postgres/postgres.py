...
class PostgresArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] owner_id: The ID of the owner (team or personal user) whose resources should be returned
        :param pulumi.Input['Version'] version: The PostgreSQL version
        :param pulumi.Input[builtins.int] disk_size_gb: The number of gigabytes of disk space to allocate for the database
        :param pulumi.Input[builtins.str] name: The name of the database as it will appear in the Render Dashboard
        """
...
class Postgres(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="enableHighAvailability")
    def enable_high_availability(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "enable_high_availability")
