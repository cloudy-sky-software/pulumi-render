...
export function getEnvGroupSecretFileOutput(args: GetEnvGroupSecretFileOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetEnvGroupSecretFileResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
