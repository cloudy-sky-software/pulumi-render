...
class RunCronJobArgs:
    def __init__(__self__, *,
                 cron_job_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a RunCronJob resource.
        :param pulumi.Input[builtins.str] cron_job_id: The ID of the cron job
        """
    ...
    def cron_job_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @cron_job_id.setter
    def cron_job_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RunCronJob(pulumi.CustomResource):
    ...
    def canceled_by(self) -> pulumi.Output[Optional[builtins.str]]:
        """
    ...
    def finished_at(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "finished_at")

    @property
    @pulumi.getter(name="startedAt")
    def started_at(self) -> pulumi.Output[Optional[builtins.str]]:
    ...
    def triggered_by(self) -> pulumi.Output[Optional[builtins.str]]:
        """
