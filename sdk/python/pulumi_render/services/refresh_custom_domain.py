...
class RefreshCustomDomainArgs:
    def __init__(__self__, *,
                 custom_domain_id_or_name: Optional[pulumi.Input[builtins.str]] = None,
                 service_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a RefreshCustomDomain resource.
        :param pulumi.Input[builtins.str] custom_domain_id_or_name: The ID or name of the custom domain
    ...
    def custom_domain_id_or_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def custom_domain_id_or_name(self, value: Optional[pulumi.Input[builtins.str]]):
