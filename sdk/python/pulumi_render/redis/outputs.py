...
@pulumi.output_type
class RedisConnectionInfo(dict):
    """
    A Redis instance
    """
    def __init__(__self__, *,
                 ...
                 redis_cli_command: str):
        """
        A Redis instance
        :param str external_connection_string: The connection string to use from outside Render
        :param str internal_connection_string: The connection string to use from within Render
        :param str redis_cli_command: The Redis CLI command to connect to the Redis instance
        """
...
class RedisDetail(dict):
    ...
    def __init__(__self__, *,
                 ...
                 options: 'outputs.RedisOptions',
                 owner: 'outputs.Owner',
                 plan: 'RedisDetailPlan',
                 region: Optional['RedisDetailRegion'] = None,
                 status: 'RedisDetailStatus',
                 updated_at: str,
                 version: str,
                 environment_id: Optional[str] = None,
                 maintenance: Optional['outputs.RedisDetailMaintenanceProperties'] = None):
        """
        A Redis instance
        :param str created_at: The creation time of the Redis instance
        :param str id: The ID of the Redis instance
        ...
        :param str name: The name of the Redis instance
        :param 'RedisOptions' options: Options for a Redis instance
        :param 'RedisDetailRegion' region: Defaults to "oregon"
        :param str updated_at: The last updated time of the Redis instance
        :param str version: The version of Redis
        :param str environment_id: The ID of the environment the Redis instance is associated with
        """
