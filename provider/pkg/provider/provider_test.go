...
func TestDiff(t *testing.T) {
	...
	resp, err := p.Diff(ctx, &pulumirpc.DiffRequest{Id: "", Urn: "urn:pulumi:some-stack::some-project::render:services:Service::someResourceName", Olds: oldsStruct, News: newsStruct})
	assert.Nil(t, err)
...
func TestCreate(t *testing.T) {
	...
	_, err := p.Create(ctx, &pulumirpc.CreateRequest{
		Urn:        "urn:pulumi:dev::render-ts::render:services:Service::webservice",
