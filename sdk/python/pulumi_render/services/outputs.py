...
class BackgroundWorkerDetailsOutput(dict):
    ...
    def __init__(__self__, *,
                 ...
                 max_shutdown_delay_seconds: Optional[builtins.int] = None,
                 ...
                 ssh_address: Optional[builtins.str] = None):
        """
        :param 'BackgroundWorkerDetailsOutputEnv' env: This field has been deprecated, runtime should be used in its place.
        :param builtins.int num_instances: For a *manually* scaled service, this is the number of instances the service is scaled to. DOES NOT indicate the number of running instances for an *autoscaled* service.
        ...
        :param builtins.int max_shutdown_delay_seconds: The maximum amount of time (in seconds) that Render waits for your application process to exit gracefully after sending it a SIGTERM signal.
        ...
        :param builtins.str ssh_address: The SSH address for the service. Only present for services that have SSH enabled.
        """
    ...
    def num_instances(self) -> builtins.int:
        """
    ...
    def max_shutdown_delay_seconds(self) -> Optional[builtins.int]:
        """
    ...
    def ssh_address(self) -> Optional[builtins.str]:
        """
...
class BackgroundWorkerOutput(dict):
    def __init__(__self__, *,
                 ...
                 image_path: Optional[builtins.str] = None,
        ...
        """
        :param builtins.str dashboard_url: The URL to view the service in the Render Dashboard
        """
    ...
    def image_path(self) -> Optional[builtins.str]:
...
class BuildFilter(dict):
    ...
    def __init__(__self__, *,
                 ignored_paths: Sequence[builtins.str],
    ...
    def ignored_paths(self) -> Sequence[builtins.str]:
...
class CriteriaPropertiesCpuProperties(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int percentage: Determines when your service will be scaled. If the average resource utilization is significantly above/below the target, we will increase/decrease the number of instances.
        """
        if enabled is None:
            enabled = False
...
class CronJobDetailsOutput(dict):
    ...
    def __init__(__self__, *,
                 ...
                 last_successful_run_at: Optional[builtins.str] = None):
        """
    ...
    def last_successful_run_at(self) -> Optional[builtins.str]:
...
class CustomDomain(dict):
    def __init__(__self__, *,
                 ...
                 id: builtins.str,
                 name: builtins.str,
                 public_suffix: builtins.str,
                 redirect_for_name: builtins.str,
    ...
    def public_suffix(self) -> builtins.str:
        return pulumi.get(self, "public_suffix")

    @property
    @pulumi.getter(name="redirectForName")
    def redirect_for_name(self) -> builtins.str:
...
class DeployImageProperties(dict):
    ...
    def __init__(__self__, *,
                 ...
                 registry_credential: Optional[builtins.str] = None,
                 sha: Optional[builtins.str] = None):
        """
        Image information used when creating the deploy. Not present for Git-backed deploys
        :param builtins.str ref: Image reference used when creating the deploy
        :param builtins.str registry_credential: Name of credential used to pull the image, if provided
        :param builtins.str sha: SHA that the image reference was resolved to when creating the deploy
        """
        if ref is not None:
    ...
    @property
    @pulumi.getter(name="registryCredential")
    def registry_credential(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def sha(self) -> Optional[builtins.str]:
        """
...
class EnvSpecificDetails(dict):
    ...
    def __init__(__self__, *,
                 ...
                 docker_command: Optional[builtins.str] = None,
                 docker_context: Optional[builtins.str] = None,
                 dockerfile_path: Optional[builtins.str] = None,
                 pre_deploy_command: Optional[builtins.str] = None,
    ...
    def docker_command(self) -> Optional[builtins.str]:
        return pulumi.get(self, "docker_command")

    @property
    @pulumi.getter(name="dockerContext")
    def docker_context(self) -> Optional[builtins.str]:
    ...
    def pre_deploy_command(self) -> Optional[builtins.str]:
...
class EnvVarInput(dict):
    ...
    def __init__(__self__, *,
                 generate_value: Optional[builtins.bool] = None,
    ...
    def generate_value(self) -> Optional[builtins.bool]:
...
class Image(dict):
    ...
    def __init__(__self__, *,
                 ...
                 owner_id: builtins.str,
                 registry_credential_id: Optional[builtins.str] = None):
        """
        :param builtins.str image_path: Path to the image used for this server (e.g docker.io/library/nginx:latest).
        :param builtins.str owner_id: The ID of the owner for this image. This should match the owner of the service as well as the owner of any specified registry credential.
        :param builtins.str registry_credential_id: Optional reference to the registry credential passed to the image repository to retrieve this image.
        """
        pulumi.set(__self__, "image_path", image_path)
        pulumi.set(__self__, "owner_id", owner_id)
    ...
    def registry_credential_id(self) -> Optional[builtins.str]:
        """
...
class MaintenanceMode(dict):
    def __init__(__self__, *,
                 ...
                 uri: builtins.str):
        """
        :param builtins.str uri: The page to be served when [maintenance mode](https://docs.render.com/maintenance-mode) is enabled. When empty, the default maintenance mode page is served.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class Route(dict):
    def __init__(__self__, *,
                 ...
                 type: 'RouteType'):
        """
        :param builtins.int priority: Redirect and Rewrite Rules are applied in priority order starting at 0
        """
...
class StaticSiteDetailsOutput(dict):
    ...
    def publish_path(self) -> builtins.str:
...
class WebServiceDetailsOutputAutoscalingProperties(dict):
    def __init__(__self__, *,
                 ...
                 min: builtins.int):
        """
        :param builtins.int max: The maximum number of instances for the service
        :param builtins.int min: The minimum number of instances for the service
        """
