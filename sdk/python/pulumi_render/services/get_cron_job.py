...
def get_cron_job(service_id: Optional[builtins.str] = None,
...
def get_cron_job_output(service_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('render:services:getCronJob', __args__, opts=opts, typ=GetCronJobResult)
    return __ret__.apply(lambda __response__: GetCronJobResult(
