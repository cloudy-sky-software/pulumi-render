...
class CidrBlockAndDescriptionArgs:
    def __init__(__self__, *,
                 ...
                 description: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] description: User-provided description of the CIDR block
        """
...
class ReadReplicaInputArgs:
    def __init__(__self__, *,
                 name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: The display name of the replica instance.
        """
