...
__all__ = [
    'GetPrivateService',
    'AwaitableGetPrivateService',
    'get_private_service',
    'get_private_service_output',
]

@pulumi.output_type
class GetPrivateService:
...
class AwaitableGetPrivateService(GetPrivateService):
...
def get_private_service(service_id: Optional[builtins.str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPrivateService:
    """
    ...
    __ret__ = pulumi.runtime.invoke('render:services:getPrivateService', __args__, opts=opts, typ=GetPrivateService).value

    return AwaitableGetPrivateService(
...
def get_private_service_output(service_id: Optional[pulumi.Input[builtins.str]] = None,
                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPrivateService]:
    """
    Use this data source to access information about an existing resource.
    ...
    __ret__ = pulumi.runtime.invoke_output('render:services:getPrivateService', __args__, opts=opts, typ=GetPrivateService)
    return __ret__.apply(lambda __response__: GetPrivateService(
