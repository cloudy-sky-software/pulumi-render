...
class StaticSite(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if service_details is not None and not isinstance(service_details, StaticSiteServiceDetailsArgs):
                service_details = service_details or {}
                def _setter(key, value):
                    service_details[key] = value
                StaticSiteServiceDetailsArgs._configure(_setter, **service_details)
