...
def get_custom_domain(custom_domain_id_or_name: Optional[builtins.str] = None,
                      service_id: Optional[builtins.str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCustomDomainResult:
    """
    Use this data source to access information about an existing resource.

    :param builtins.str custom_domain_id_or_name: The ID or name of the custom domain
...
def get_custom_domain_output(custom_domain_id_or_name: Optional[pulumi.Input[builtins.str]] = None,
