...
class PostgresConnectionInfo:
    ...
    def psql_command(self) -> builtins.str:
...
def get_postgres_connection_info(postgres_id: Optional[builtins.str] = None,
...
def get_postgres_connection_info_output(postgres_id: Optional[pulumi.Input[builtins.str]] = None,
                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[PostgresConnectionInfo]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
