...
export class ServicesStaticSite extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ServicesStaticSite {
        return new ServicesStaticSite(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'render:services:ServicesStaticSite';

    /**
     * Returns true if the given object is an instance of ServicesStaticSite.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ServicesStaticSite {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ServicesStaticSite.__pulumiType;
    }
    ...
    public readonly serviceDetails!: pulumi.Output<outputs.services.StaticSiteServiceDetails | undefined>;
    ...
    /**
     * Create a ServicesStaticSite resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ServicesStaticSiteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["serviceDetails"] = args ? (args.serviceDetails ? pulumi.output(args.serviceDetails).apply(inputs.services.staticSiteServiceDetailsArgsProvideDefaults) : undefined) : undefined;
        ...
        super(ServicesStaticSite.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ServicesStaticSiteArgs {
    /**
     * Whether to auto deploy the service or not upon git push.
     */
    ...
    serviceDetails?: pulumi.Input<inputs.services.StaticSiteServiceDetailsArgs>;
