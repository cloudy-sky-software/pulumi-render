...
class RestoreSnapshotArgs:
    ...
    def snapshot_key(self) -> pulumi.Input[_builtins.str]:
        return pulumi.get(self, "snapshot_key")

    @snapshot_key.setter
    def snapshot_key(self, value: pulumi.Input[_builtins.str]):
...
class RestoreSnapshot(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="snapshotKey")
    def snapshot_key(self) -> pulumi.Output[_builtins.str]:
        return pulumi.get(self, "snapshot_key")
