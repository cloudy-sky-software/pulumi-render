...
class WebServiceArgs:
    def __init__(__self__, *,
                 ...
                 service_details: pulumi.Input[Optional['WebServiceDetailsCreateArgs']] = None,
    ...
    def service_details(self) -> pulumi.Input[Optional['WebServiceDetailsCreateArgs']]:
        return pulumi.get(self, "service_details")

    @service_details.setter
    def service_details(self, value: pulumi.Input[Optional['WebServiceDetailsCreateArgs']]):
...
class WebService(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 service_details: pulumi.Input[Optional[Union['WebServiceDetailsCreateArgs', 'WebServiceDetailsCreateArgsDict']]] = None,
                 type: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
