...
class ResourcesToEnvironmentArgs:
    def __init__(__self__, *,
                 resource_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
    ...
    def resource_ids(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        return pulumi.get(self, "resource_ids")

    @resource_ids.setter
    def resource_ids(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class ResourcesToEnvironment(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="resourceIds")
    def resource_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        return pulumi.get(self, "resource_ids")
