...
class Redis(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A Redis instance
        :param builtins.str created_at: The creation time of the Redis instance
        :param builtins.str dashboard_url: The URL to view the Redis instance in the Render Dashboard
        :param builtins.str id: The ID of the Redis instance
        :param Sequence['CidrBlockAndDescription'] ip_allow_list: The IP allow list for the Redis instance
        :param builtins.str name: The name of the Redis instance
        :param 'RedisOptions' options: Options for a Redis instance
        :param 'RedisRegion' region: Defaults to "oregon"
        :param builtins.str updated_at: The last updated time of the Redis instance
        :param builtins.str version: The version of Redis
        :param builtins.str environment_id: The ID of the environment the Redis instance is associated with
        """
