...
export class Scale extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Scale {
        return new Scale(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'render:services:Scale';

    /**
     * Returns true if the given object is an instance of Scale.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Scale {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Scale.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: ScaleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Scale.__pulumiType, name, resourceInputs, opts);
    }
}
