...
export class EnvGroupSecretFile extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EnvGroupSecretFile {
        return new EnvGroupSecretFile(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'render:env-groups:EnvGroupSecretFile';

    /**
     * Returns true if the given object is an instance of EnvGroupSecretFile.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is EnvGroupSecretFile {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === EnvGroupSecretFile.__pulumiType;
    }
     ...
     */
    constructor(name: string, args?: EnvGroupSecretFileArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(EnvGroupSecretFile.__pulumiType, name, resourceInputs, opts);
    }
}
