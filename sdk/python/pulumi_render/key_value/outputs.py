...
class KeyValue(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A Key Value instance
        :param str created_at: The creation time of the Key Value instance
        :param str dashboard_url: The URL to view the Key Value instance in the Render Dashboard
        :param str id: The ID of the Key Value instance
        :param Sequence['CidrBlockAndDescription'] ip_allow_list: The IP allow list for the Key Value instance
        :param str name: The name of the Key Value instance
        :param 'KeyValueOptions' options: Options for a Key Value instance
        :param 'KeyValueRegion' region: Defaults to "oregon"
        :param str updated_at: The last updated time of the Key Value instance
        :param str version: The version of Key Value
        :param str environment_id: The ID of the environment the Key Value instance is associated with
        """
