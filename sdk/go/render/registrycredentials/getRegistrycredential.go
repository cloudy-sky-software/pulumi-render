...
func (o GetRegistrycredentialResultOutput) Items() RegistryCredentialTypeOutput {
	return o.ApplyT(func(v GetRegistrycredentialResult) RegistryCredentialType { return v.Items }).(RegistryCredentialTypeOutput)
}
