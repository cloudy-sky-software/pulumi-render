...
class AwaitableGetStaticSite(GetStaticSite):
...
def get_static_site(service_id: Optional[builtins.str] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetStaticSite:
    """
    ...
    __ret__ = pulumi.runtime.invoke('render:services:getStaticSite', __args__, opts=opts, typ=GetStaticSite).value

    return AwaitableGetStaticSite(
...
def get_static_site_output(service_id: Optional[pulumi.Input[builtins.str]] = None,
                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetStaticSite]:
    """
    Use this data source to access information about an existing resource.
    ...
    __ret__ = pulumi.runtime.invoke_output('render:services:getStaticSite', __args__, opts=opts, typ=GetStaticSite)
    return __ret__.apply(lambda __response__: GetStaticSite(
