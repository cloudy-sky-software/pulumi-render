...
namespace Pulumi.Render.Services
{
    ...
    {
        public readonly ImmutableArray<Outputs.ListServiceHeadersResponse> Items;

        [OutputConstructor]
        private ListServiceHeadersResult(ImmutableArray<Outputs.ListServiceHeadersResponse> items)
        {
            Items = items;
        }
    }
