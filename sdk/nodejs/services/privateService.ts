...
export class PrivateService extends pulumi.CustomResource {
    ...
    public readonly autoDeploy!: pulumi.Output<enums.services.PrivateServiceServiceAutoDeploy | undefined>;
...
export interface PrivateServiceArgs {
     ...
     * Defaults to "yes"
     */
    autoDeploy?: pulumi.Input<enums.services.PrivateServiceServiceCreateAutoDeploy>;
    /**
