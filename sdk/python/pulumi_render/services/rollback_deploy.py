...
class RollbackDeployArgs:
    def __init__(__self__, *,
                 deploy_id: pulumi.Input[builtins.str],
                 service_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a RollbackDeploy resource.
        :param pulumi.Input[builtins.str] deploy_id: The ID of the deploy to roll back to
    ...
    def deploy_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @deploy_id.setter
    def deploy_id(self, value: pulumi.Input[builtins.str]):
...
class RollbackDeploy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 deploy_id: Optional[pulumi.Input[builtins.str]] = None,
                 service_id: Optional[pulumi.Input[builtins.str]] = None,
                 __props__=None):
        """
    ...
    @property
    @pulumi.getter(name="deployId")
    def deploy_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the deploy to roll back to
        """
        return pulumi.get(self, "deploy_id")
