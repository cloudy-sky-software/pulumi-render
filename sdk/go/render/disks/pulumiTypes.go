...
type DiskWithCursorpropertiesdiskOutput struct{ *pulumi.OutputState }

func (DiskWithCursorpropertiesdiskOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*DiskWithCursorpropertiesdisk)(nil)).Elem()
}

func (o DiskWithCursorpropertiesdiskOutput) ToDiskWithCursorpropertiesdiskOutput() DiskWithCursorpropertiesdiskOutput {
	return o
}

func (o DiskWithCursorpropertiesdiskOutput) ToDiskWithCursorpropertiesdiskOutputWithContext(ctx context.Context) DiskWithCursorpropertiesdiskOutput {
	return o
}

func (o DiskWithCursorpropertiesdiskOutput) CreatedAt() pulumi.StringOutput {
	return o.ApplyT(func(v DiskWithCursorpropertiesdisk) string { return v.CreatedAt }).(pulumi.StringOutput)
}

func (o DiskWithCursorpropertiesdiskOutput) Id() pulumi.StringOutput {
	return o.ApplyT(func(v DiskWithCursorpropertiesdisk) string { return v.Id }).(pulumi.StringOutput)
}

func (o DiskWithCursorpropertiesdiskOutput) MountPath() pulumi.StringOutput {
	return o.ApplyT(func(v DiskWithCursorpropertiesdisk) string { return v.MountPath }).(pulumi.StringOutput)
}

func (o DiskWithCursorpropertiesdiskOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v DiskWithCursorpropertiesdisk) string { return v.Name }).(pulumi.StringOutput)
}

func (o DiskWithCursorpropertiesdiskOutput) ServiceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v DiskWithCursorpropertiesdisk) *string { return v.ServiceId }).(pulumi.StringPtrOutput)
}

func (o DiskWithCursorpropertiesdiskOutput) SizeGB() pulumi.IntOutput {
	return o.ApplyT(func(v DiskWithCursorpropertiesdisk) int { return v.SizeGB }).(pulumi.IntOutput)
}

func (o DiskWithCursorpropertiesdiskOutput) UpdatedAt() pulumi.StringOutput {
	return o.ApplyT(func(v DiskWithCursorpropertiesdisk) string { return v.UpdatedAt }).(pulumi.StringOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(DiskWithCursorpropertiesdiskOutput{})
}
