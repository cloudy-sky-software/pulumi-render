...
def list_env_vars_for_service(service_id: Optional[builtins.str] = None,
...
def list_env_vars_for_service_output(service_id: Optional[pulumi.Input[builtins.str]] = None,
