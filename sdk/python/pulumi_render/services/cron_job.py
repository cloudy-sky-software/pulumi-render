...
class CronJobArgs:
    def __init__(__self__, *,
                 ...
                 service_details: pulumi.Input[Optional['CronJobDetailsCreateArgs']] = None,
    ...
    def service_details(self) -> pulumi.Input[Optional['CronJobDetailsCreateArgs']]:
        return pulumi.get(self, "service_details")

    @service_details.setter
    def service_details(self, value: pulumi.Input[Optional['CronJobDetailsCreateArgs']]):
...
class CronJob(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 service_details: pulumi.Input[Optional[Union['CronJobDetailsCreateArgs', 'CronJobDetailsCreateArgsDict']]] = None,
                 type: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
