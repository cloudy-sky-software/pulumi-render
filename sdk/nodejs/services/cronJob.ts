...
export class CronJob extends pulumi.CustomResource {
    ...
    constructor(name: string, args: CronJobArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["serviceDetails"] = args ? pulumi.output(args.serviceDetails).apply(v => v === undefined ? undefined : inputs.services.cronJobDetailsCreateArgsProvideDefaults(v)) : undefined;
...
export interface CronJobArgs {
    ...
    serviceDetails?: pulumi.Input<inputs.services.CronJobDetailsCreateArgs | undefined>;
