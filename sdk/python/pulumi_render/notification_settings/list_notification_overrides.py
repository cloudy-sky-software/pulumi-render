...
__all__ = [
    ...
    'AwaitableListNotificationOverridesResult',
    'list_notification_overrides',
    'list_notification_overrides_output',
]

@pulumi.output_type
class ListNotificationOverridesResult:
    ...
    @property
    @pulumi.getter
    def items(self) -> Sequence['outputs.NotificationOverrideWithCursor']:
        return pulumi.get(self, "items")


class AwaitableListNotificationOverridesResult(ListNotificationOverridesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ListNotificationOverridesResult(
            items=self.items)
