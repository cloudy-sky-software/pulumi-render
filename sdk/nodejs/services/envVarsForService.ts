...
export class EnvVarsForService extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): EnvVarsForService {
        return new EnvVarsForService(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'render:services:EnvVarsForService';

    /**
     * Returns true if the given object is an instance of EnvVarsForService.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is EnvVarsForService {
     ...
     */
    constructor(name: string, args?: EnvVarsForServiceArgs, opts?: pulumi.CustomResourceOptions) {
