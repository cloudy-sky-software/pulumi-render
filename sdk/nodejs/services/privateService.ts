...
export class PrivateService extends pulumi.CustomResource {
    ...
    declare public readonly serviceDetails: pulumi.Output<outputs.services.PrivateServiceDetailsOutput | undefined>;
    ...
    constructor(name: string, args: PrivateServiceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["serviceDetails"] = args ? pulumi.output(args.serviceDetails).apply(v => v === undefined ? undefined : inputs.services.privateServiceDetailsCreateArgsProvideDefaults(v)) : undefined;
            resourceInputs["type"] = (args?.type) ?? "private_service";
...
export interface PrivateServiceArgs {
    ...
    serviceDetails?: pulumi.Input<inputs.services.PrivateServiceDetailsCreateArgs | undefined>;
