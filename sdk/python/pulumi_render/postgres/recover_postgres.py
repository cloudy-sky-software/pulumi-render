...
class RecoverPostgresArgs:
    def __init__(__self__, *,
                 restore_time: pulumi.Input[builtins.str],
                 datadog_api_key: Optional[pulumi.Input[builtins.str]] = None,
                 environment_id: Optional[pulumi.Input[builtins.str]] = None,
                 plan: Optional[pulumi.Input[builtins.str]] = None,
                 postgres_id: Optional[pulumi.Input[builtins.str]] = None,
                 restore_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a RecoverPostgres resource.
        :param pulumi.Input[builtins.str] restore_time: The point in time to restore the database to. See `/recovery-info` for restore availability
        :param pulumi.Input[builtins.str] datadog_api_key: Datadog API key to use for monitoring the new database. Defaults to the API key of the original database. Use an empty string to prevent copying of the API key to the new database.
        :param pulumi.Input[builtins.str] environment_id: The environment to create the new database in. Defaults to the environment of the original database.
        :param pulumi.Input[builtins.str] plan: The plan to use for the new database. Defaults to the same plan as the original database. Cannot be a lower tier plan than the original database.
        :param pulumi.Input[builtins.str] restore_name: Name of the new database.
        """
    ...
    def restore_time(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @restore_time.setter
    def restore_time(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "restore_time", value)

    @property
    @pulumi.getter(name="datadogApiKey")
    def datadog_api_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def datadog_api_key(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def postgres_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "postgres_id")

    @postgres_id.setter
    def postgres_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RecoverPostgres(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="datadogApiKey")
    def datadog_api_key(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Datadog API key to use for monitoring the new database. Defaults to the API key of the original database. Use an empty string to prevent copying of the API key to the new database.
        """
        return pulumi.get(self, "datadog_api_key")
    ...
    def high_availability_enabled(self) -> pulumi.Output[builtins.bool]:
    ...
    def primary_postgres_id(self) -> pulumi.Output[Optional[builtins.str]]:
    ...
    @property
    @pulumi.getter(name="restoreName")
    def restore_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Name of the new database.
        """
        return pulumi.get(self, "restore_name")
    ...
    @property
    @pulumi.getter(name="restoreTime")
    def restore_time(self) -> pulumi.Output[builtins.str]:
        """
        The point in time to restore the database to. See `/recovery-info` for restore availability
        """
        return pulumi.get(self, "restore_time")
